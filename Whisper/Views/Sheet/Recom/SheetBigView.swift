...
struct SheetBigView: View {
    ...
    var body: some View {
        ZStack(alignment: .top){
            //歌单封面logo
            WebImageView(self.coverImgUrl,renderingMode: .original,qulity:ImageQulity.Regular)
                .cornerRadius(10)
                .scaledToFit()
...
struct SheetBigView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return SheetBigView(sheetTitle:"歌单名称歌名称歌名称歌名称歌名称歌名称歌单歌单名称",play:"1232",coverImgUrl:sheet.cover_img_url)
    }
}
